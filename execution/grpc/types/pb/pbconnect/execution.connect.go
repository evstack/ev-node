...
type ExecutorServiceClient interface {
	...
	InitChain(context.Context, *connect.Request[pb.InitChainRequest]) (*connect.Response[pb.InitChainResponse], error)
	// GetTxs fetches available transactions from the execution layer's mempool
	GetTxs(context.Context, *connect.Request[pb.GetTxsRequest]) (*connect.Response[pb.GetTxsResponse], error)
	// ExecuteTxs processes transactions to produce a new block state
	ExecuteTxs(context.Context, *connect.Request[pb.ExecuteTxsRequest]) (*connect.Response[pb.ExecuteTxsResponse], error)
	...
	GetExecutionInfo(context.Context, *connect.Request[pb.GetExecutionInfoRequest]) (*connect.Response[pb.GetExecutionInfoResponse], error)
	// FilterTxs validates force-included transactions and calculates gas for all transactions
	FilterTxs(context.Context, *connect.Request[pb.FilterTxsRequest]) (*connect.Response[pb.FilterTxsResponse], error)
}
...
type executorServiceClient struct {
	initChain        *connect.Client[pb.InitChainRequest, pb.InitChainResponse]
	getTxs           *connect.Client[pb.GetTxsRequest, pb.GetTxsResponse]
	executeTxs       *connect.Client[pb.ExecuteTxsRequest, pb.ExecuteTxsResponse]
	setFinal         *connect.Client[pb.SetFinalRequest, pb.SetFinalResponse]
	getExecutionInfo *connect.Client[pb.GetExecutionInfoRequest, pb.GetExecutionInfoResponse]
	filterTxs        *connect.Client[pb.FilterTxsRequest, pb.FilterTxsResponse]
}

// InitChain calls evnode.v1.ExecutorService.InitChain.
func (c *executorServiceClient) InitChain(ctx context.Context, req *connect.Request[pb.InitChainRequest]) (*connect.Response[pb.InitChainResponse], error) {
	return c.initChain.CallUnary(ctx, req)
}

// GetTxs calls evnode.v1.ExecutorService.GetTxs.
func (c *executorServiceClient) GetTxs(ctx context.Context, req *connect.Request[pb.GetTxsRequest]) (*connect.Response[pb.GetTxsResponse], error) {
	return c.getTxs.CallUnary(ctx, req)
}

// ExecuteTxs calls evnode.v1.ExecutorService.ExecuteTxs.
func (c *executorServiceClient) ExecuteTxs(ctx context.Context, req *connect.Request[pb.ExecuteTxsRequest]) (*connect.Response[pb.ExecuteTxsResponse], error) {
...
func (c *executorServiceClient) GetExecutionInfo(ctx context.Context, req *connect.Request[pb.GetExecutionInfoRequest]) (*connect.Response[pb.GetExecutionInfoResponse], error) {
	return c.getExecutionInfo.CallUnary(ctx, req)
}

// FilterTxs calls evnode.v1.ExecutorService.FilterTxs.
func (c *executorServiceClient) FilterTxs(ctx context.Context, req *connect.Request[pb.FilterTxsRequest]) (*connect.Response[pb.FilterTxsResponse], error) {
...
func (UnimplementedExecutorServiceHandler) InitChain(context.Context, *connect.Request[pb.InitChainRequest]) (*connect.Response[pb.InitChainResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("evnode.v1.ExecutorService.InitChain is not implemented"))
}

func (UnimplementedExecutorServiceHandler) GetTxs(context.Context, *connect.Request[pb.GetTxsRequest]) (*connect.Response[pb.GetTxsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("evnode.v1.ExecutorService.GetTxs is not implemented"))
}

func (UnimplementedExecutorServiceHandler) ExecuteTxs(context.Context, *connect.Request[pb.ExecuteTxsRequest]) (*connect.Response[pb.ExecuteTxsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("evnode.v1.ExecutorService.ExecuteTxs is not implemented"))
}

func (UnimplementedExecutorServiceHandler) SetFinal(context.Context, *connect.Request[pb.SetFinalRequest]) (*connect.Response[pb.SetFinalResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("evnode.v1.ExecutorService.SetFinal is not implemented"))
}

func (UnimplementedExecutorServiceHandler) GetExecutionInfo(context.Context, *connect.Request[pb.GetExecutionInfoRequest]) (*connect.Response[pb.GetExecutionInfoResponse], error) {
...
func (UnimplementedExecutorServiceHandler) FilterTxs(context.Context, *connect.Request[pb.FilterTxsRequest]) (*connect.Response[pb.FilterTxsResponse], error) {
