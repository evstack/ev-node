...
- Added `store-info` CLI command to inspect go-header P2P stores and display head/tail information for both header and data stores ([#2835](https://github.com/evstack/ev-node/pull/2835))
