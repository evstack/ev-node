...
pub mod signer_service_server {
    ...
    #[async_trait]
    pub trait SignerService: std::marker::Send + std::marker::Sync + 'static {
        /// Sign signs the given message.
        async fn sign(
            &self,
    ...
    /// The SignerService defines the RPCs to sign and to retrieve the public key.
    #[derive(Debug)]
    pub struct SignerServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> Clone for SignerServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "evnode.v1.SignerService";
    impl<T> tonic::server::NamedService for SignerServiceServer<T> {
...
pub mod p2p_service_server {
    ...
    #[async_trait]
    pub trait P2pService: std::marker::Send + std::marker::Sync + 'static {
        /// GetPeerInfo returns information about the connected peers
    ...
    impl<T> Clone for P2pServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "evnode.v1.P2PService";
    impl<T> tonic::server::NamedService for P2pServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
pub mod store_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_p2p_store_info(
            &mut self,
            request: impl tonic::IntoRequest<()>,
        ) -> std::result::Result<
            tonic::Response<super::GetP2pStoreInfoResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("evnode.v1.StoreService", "GetP2PStoreInfo"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod store_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/evnode.v1.StoreService/GetP2PStoreInfo" => {
                    #[allow(non_camel_case_types)]
                    struct GetP2PStoreInfoSvc<T: StoreService>(pub Arc<T>);
                    impl<T: StoreService> tonic::server::UnaryService<()>
                    for GetP2PStoreInfoSvc<T> {
                        type Response = super::GetP2pStoreInfoResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as StoreService>::get_p2p_store_info(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetP2PStoreInfoSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "evnode.v1.StoreService";
...
pub mod config_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "evnode.v1.ConfigService";
