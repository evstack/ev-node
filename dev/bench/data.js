    ...
    "EVM Contract Roundtrip": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "212b03405c5229b2f8d4f372a3a8299e077e276d",
          "message": "build(deps): Bump actions/github-script from 8 to 9 (#3247)\n\nBumps [actions/github-script](https://github.com/actions/github-script) from 8 to 9.\n- [Release notes](https://github.com/actions/github-script/releases)\n- [Commits](https://github.com/actions/github-script/compare/v8...v9)\n\n---\nupdated-dependencies:\n- dependency-name: actions/github-script\n  dependency-version: '9'\n  dependency-type: direct:production\n  update-type: version-update:semver-major\n...\n\nSigned-off-by: dependabot[bot] <support@github.com>\nCo-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>",
          "timestamp": "2026-04-14T09:15:56+02:00",
          "tree_id": "6a0f73ed1ee1ba47cdb42f648f305ca31c048c9c",
          "url": "https://github.com/evstack/ev-node/commit/212b03405c5229b2f8d4f372a3a8299e077e276d"
        },
        "date": 1776154177491,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkEvmContractRoundtrip",
            "value": 882461922,
            "unit": "ns/op\t30523944 B/op\t  165270 allocs/op",
            "extra": "2 times\n4 procs"
          },
          {
            "name": "BenchmarkEvmContractRoundtrip - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "7c960d9abc041317a0354005ec8c7e65cd19e00f",
          "message": "build(deps): Bump softprops/action-gh-release from 2 to 3 (#3248)\n\nBumps [softprops/action-gh-release](https://github.com/softprops/action-gh-release) from 2 to 3.\n- [Release notes](https://github.com/softprops/action-gh-release/releases)\n- [Changelog](https://github.com/softprops/action-gh-release/blob/master/CHANGELOG.md)\n- [Commits](https://github.com/softprops/action-gh-release/compare/v2...v3)\n\n---\nupdated-dependencies:\n- dependency-name: softprops/action-gh-release\n  dependency-version: '3'\n  dependency-type: direct:production\n  update-type: version-update:semver-major\n...\n\nSigned-off-by: dependabot[bot] <support@github.com>\nCo-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>",
          "timestamp": "2026-04-14T09:16:20+02:00",
          "tree_id": "57803b86523edc61876fb54258800917d1851844",
          "url": "https://github.com/evstack/ev-node/commit/7c960d9abc041317a0354005ec8c7e65cd19e00f"
        },
        "date": 1776154479401,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkEvmContractRoundtrip",
            "value": 888659994,
            "unit": "ns/op\t31008356 B/op\t  170414 allocs/op",
            "extra": "2 times\n4 procs"
          },
          {
            "name": "BenchmarkEvmContractRoundtrip - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "554a195bab1c69b8cb9a1b2e9fc73435c178c851",
          "message": "feat: solo sequencer, testapp max blob size ldflags (#3235)\n\n* feat: solo sequencer\n\n* refactor: set max blob size as ldflag\n\n* refactor: wire solo sequencer in testapp\n\n* updates\n\n* fix ldflag\n\n* cleanup api\n\n* better defaults\n\n* cleanup readme\n\n* fixes\n\n* nit\n\n* fix typo",
          "timestamp": "2026-04-14T13:43:07Z",
          "tree_id": "c954b3df310a8d4a2d223dd886930b6b3ba3114d",
          "url": "https://github.com/evstack/ev-node/commit/554a195bab1c69b8cb9a1b2e9fc73435c178c851"
        },
        "date": 1776175599315,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkEvmContractRoundtrip",
            "value": 885890603,
            "unit": "ns/op\t29878164 B/op\t  160411 allocs/op",
            "extra": "2 times\n4 procs"
          },
          {
            "name": "BenchmarkEvmContractRoundtrip - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "2865d6d2917c6346404af9ade20b129e2830b88f",
          "message": "chore(apps): cleanup unecessary replaces (#3253)",
          "timestamp": "2026-04-14T16:59:39+02:00",
          "tree_id": "2968d5ed1bd0315b25b9fab322fc098ce68be2cf",
          "url": "https://github.com/evstack/ev-node/commit/2865d6d2917c6346404af9ade20b129e2830b88f"
        },
        "date": 1776179012111,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkEvmContractRoundtrip",
            "value": 905241510,
            "unit": "ns/op\t31357856 B/op\t  170890 allocs/op",
            "extra": "2 times\n4 procs"
          },
          {
            "name": "BenchmarkEvmContractRoundtrip - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "77b39d456b50ac83fe319fcaf248fff81af8f188",
          "message": "build(deps): Bump dompurify from 3.3.2 to 3.4.0 in /docs in the npm_and_yarn group across 1 directory (#3257)\n\nbuild(deps): Bump dompurify\n\nBumps the npm_and_yarn group with 1 update in the /docs directory: [dompurify](https://github.com/cure53/DOMPurify).\n\n\nUpdates `dompurify` from 3.3.2 to 3.4.0\n- [Release notes](https://github.com/cure53/DOMPurify/releases)\n- [Commits](https://github.com/cure53/DOMPurify/compare/3.3.2...3.4.0)\n\n---\nupdated-dependencies:\n- dependency-name: dompurify\n  dependency-version: 3.4.0\n  dependency-type: indirect\n  dependency-group: npm_and_yarn\n...\n\nSigned-off-by: dependabot[bot] <support@github.com>\nCo-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>",
          "timestamp": "2026-04-16T15:50:32+02:00",
          "tree_id": "7767400a19ab7fa31f8fe9212f7ce540e6b9a88a",
          "url": "https://github.com/evstack/ev-node/commit/77b39d456b50ac83fe319fcaf248fff81af8f188"
        },
        "date": 1776347524001,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkEvmContractRoundtrip",
            "value": 915461076,
            "unit": "ns/op\t31431068 B/op\t  171417 allocs/op",
            "extra": "2 times\n4 procs"
          },
          {
            "name": "BenchmarkEvmContractRoundtrip - ns/op",
        ...
        "benches": [
          {
            "name": "BenchmarkProduceBlock/empty_batch",
            "value": 40798,
            "unit": "ns/op\t    7163 B/op\t      71 allocs/op",
            "extra": "28747 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/single_tx",
            "value": 42337,
            "unit": "ns/op\t    7586 B/op\t      81 allocs/op",
            "extra": "29326 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/single_tx - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/100_txs",
            "value": 52167,
            "unit": "ns/op\t   26221 B/op\t      81 allocs/op",
            "extra": "23860 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/100_txs - ns/op",
        ...
        "benches": [
          {
            "name": "BenchmarkProduceBlock/empty_batch",
            "value": 38341,
            "unit": "ns/op\t    7084 B/op\t      71 allocs/op",
            "extra": "31624 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/single_tx",
            "value": 39164,
            "unit": "ns/op\t    7548 B/op\t      81 allocs/op",
            "extra": "30682 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/single_tx - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/100_txs",
            "value": 49396,
            "unit": "ns/op\t   26233 B/op\t      81 allocs/op",
            "extra": "24352 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/100_txs - ns/op",
      ...
      },
      {
        ...
        "benches": [
          ...
          },
          {
            "name": "BenchmarkProduceBlock/100_txs",
            "value": 50327,
            "unit": "ns/op\t   26179 B/op\t      81 allocs/op",
            "extra": "26120 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/100_txs - ns/op",
      ...
      },
      {
        ...
        "benches": [
          ...
          },
          {
            "name": "BenchmarkProduceBlock/100_txs",
            "value": 47018,
            "unit": "ns/op\t   26198 B/op\t      81 allocs/op",
            "extra": "25521 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/100_txs - ns/op",
        ...
        "benches": [
          {
            "name": "BenchmarkProduceBlock/empty_batch",
            "value": 37921,
            "unit": "ns/op\t    7068 B/op\t      71 allocs/op",
            "extra": "32272 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/single_tx",
            "value": 38651,
            "unit": "ns/op\t    7539 B/op\t      81 allocs/op",
            "extra": "31010 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/single_tx - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/100_txs",
            "value": 48051,
            "unit": "ns/op\t   26204 B/op\t      81 allocs/op",
            "extra": "25467 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/100_txs - ns/op",
      ...
      },
      {
        ...
        "benches": [
          ...
          },
          {
            "name": "BenchmarkProduceBlock/single_tx",
            "value": 37649,
            "unit": "ns/op\t    4965 B/op\t      54 allocs/op",
            "extra": "31983 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/single_tx - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/100_txs",
            "value": 44331,
            "unit": "ns/op\t   10272 B/op\t      54 allocs/op",
            "extra": "27208 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/100_txs - ns/op",
      ...
      },
      {
        ...
        "benches": [
          ...
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch",
            "value": 39689,
            "unit": "ns/op\t    4807 B/op\t      50 allocs/op",
            "extra": "30664 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/single_tx",
            "value": 40181,
            "unit": "ns/op\t    5011 B/op\t      54 allocs/op",
            "extra": "30229 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/single_tx - ns/op",
        ...
        "benches": [
          {
            "name": "BenchmarkProduceBlock/empty_batch",
            "value": 37160,
            "unit": "ns/op\t    4763 B/op\t      50 allocs/op",
            "extra": "32391 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/100_txs",
            "value": 46872,
            "unit": "ns/op\t   10262 B/op\t      54 allocs/op",
            "extra": "27500 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/100_txs - ns/op",
        ...
        "benches": [
          {
            "name": "BenchmarkProduceBlock/empty_batch",
            "value": 36726,
            "unit": "ns/op\t    4748 B/op\t      50 allocs/op",
            "extra": "33030 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/100_txs",
            "value": 43345,
            "unit": "ns/op\t   10252 B/op\t      54 allocs/op",
            "extra": "27796 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/100_txs - ns/op",
