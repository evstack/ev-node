    ...
    "EVM Contract Roundtrip": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "0ef6039d563443269e54eb25f11db5877f9f094c",
          "message": "build(deps): Bump golangci/golangci-lint-action from 9.2.1 to 9.3.0 (#3369)\n\nBumps [golangci/golangci-lint-action](https://github.com/golangci/golangci-lint-action) from 9.2.1 to 9.3.0.\n- [Release notes](https://github.com/golangci/golangci-lint-action/releases)\n- [Commits](https://github.com/golangci/golangci-lint-action/compare/v9.2.1...v9.3.0)\n\n---\nupdated-dependencies:\n- dependency-name: golangci/golangci-lint-action\n  dependency-version: 9.3.0\n  dependency-type: direct:production\n  update-type: version-update:semver-minor\n...\n\nSigned-off-by: dependabot[bot] <support@github.com>\nCo-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>",
          "timestamp": "2026-06-30T10:42:18+02:00",
          "tree_id": "b036d64b4ef59cbc2279fd84d718f4b414bcac85",
          "url": "https://github.com/evstack/ev-node/commit/0ef6039d563443269e54eb25f11db5877f9f094c"
        },
        "date": 1782809648477,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkEvmContractRoundtrip",
            "value": 893605960,
            "unit": "ns/op\t31864472 B/op\t  179399 allocs/op",
            "extra": "2 times\n4 procs"
          },
          {
            "name": "BenchmarkEvmContractRoundtrip - ns/op",
      ...
      },
      {
        "commit": {
          "author": {
            "email": "blackflytech@outlook.com",
            "name": "blackflytech",
            "username": "blackflytech"
          },
          "committer": {
            "email": "noreply@github.com",
            "name": "GitHub",
          ...
          "distinct": false,
          "id": "437a51f7b4fb0805e8512af9c822305712f3e01a",
          "message": "test: make single sequencer timestamp assertions timezone-agnostic (#3367)\n\nSigned-off-by: blackflytech <blackflytech@outlook.com>",
          "timestamp": "2026-06-30T08:34:23Z",
          "tree_id": "5288f1d86d0b069dede1a6aff37009b1aa1fc3d6",
          "url": "https://github.com/evstack/ev-node/commit/437a51f7b4fb0805e8512af9c822305712f3e01a"
        },
        "date": 1782810865523,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkEvmContractRoundtrip",
            "value": 902083828,
            "unit": "ns/op\t29156840 B/op\t  150070 allocs/op",
            "extra": "2 times\n4 procs"
          },
          {
            "name": "BenchmarkEvmContractRoundtrip - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/evstack/ev-node/commit/fdc2b50f08b22a94af6ec404f4a6741771989fd7"
        },
        "date": 1783610067541,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkEvmContractRoundtrip",
            "value": 900956202,
            "unit": "ns/op\t31608388 B/op\t  174545 allocs/op",
            "extra": "2 times\n4 procs"
          },
          {
            "name": "BenchmarkEvmContractRoundtrip - ns/op",
      ...
      },
      {
        ...
        "benches": [
          ...
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch",
            "value": 37128,
            "unit": "ns/op\t    4863 B/op\t      51 allocs/op",
            "extra": "32775 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/single_tx",
            "value": 38258,
            "unit": "ns/op\t    5072 B/op\t      55 allocs/op",
            "extra": "32108 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/single_tx - ns/op",
        ...
        "benches": [
          {
            "name": "BenchmarkProduceBlock/empty_batch",
            "value": 40650,
            "unit": "ns/op\t    4937 B/op\t      51 allocs/op",
            "extra": "29908 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/single_tx",
            "value": 41286,
            "unit": "ns/op\t    5133 B/op\t      55 allocs/op",
            "extra": "29784 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/single_tx - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/100_txs",
            "value": 49682,
            "unit": "ns/op\t   10375 B/op\t      55 allocs/op",
            "extra": "23212 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/100_txs - ns/op",
        ...
        "benches": [
          {
            "name": "BenchmarkProduceBlock/100_txs",
            "value": 44721,
            "unit": "ns/op\t   10386 B/op\t      55 allocs/op",
            "extra": "27076 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/100_txs - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch",
            "value": 38168,
            "unit": "ns/op\t    4886 B/op\t      51 allocs/op",
            "extra": "31844 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch - ns/op",
        ...
        "benches": [
          {
            "name": "BenchmarkProduceBlock/empty_batch",
            "value": 39756,
            "unit": "ns/op\t    4916 B/op\t      51 allocs/op",
            "extra": "30691 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/single_tx",
            "value": 40312,
            "unit": "ns/op\t    5127 B/op\t      55 allocs/op",
            "extra": "29978 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/single_tx - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/100_txs",
            "value": 46907,
            "unit": "ns/op\t   10421 B/op\t      55 allocs/op",
            "extra": "26100 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/100_txs - ns/op",
        ...
        "benches": [
          {
            "name": "BenchmarkProduceBlock/empty_batch",
            "value": 38347,
            "unit": "ns/op\t    4895 B/op\t      51 allocs/op",
            "extra": "31473 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/empty_batch - ns/op",
          ...
          },
          {
            "name": "BenchmarkProduceBlock/single_tx",
            "value": 39041,
            "unit": "ns/op\t    5100 B/op\t      55 allocs/op",
            "extra": "30973 times\n4 procs"
          },
          {
            "name": "BenchmarkProduceBlock/single_tx - ns/op",
