...
func (_c *MockClient_Subscribe_Call) Return(resultRetrieveCh <-chan da.ResultRetrieve, err error) *MockClient_Subscribe_Call {
	_c.Call.Return(resultRetrieveCh, err)
	return _c
}
