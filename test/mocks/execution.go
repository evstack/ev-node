...
func (_mock *MockExecutor) Rollback(ctx context.Context, height uint64) error {
...
//   - ctx context.Context
//   - height uint64
func (_e *MockExecutor_Expecter) Rollback(ctx interface{}, height interface{}) *MockExecutor_Rollback_Call {
	return &MockExecutor_Rollback_Call{Call: _e.mock.On("Rollback", ctx, height)}
}

func (_c *MockExecutor_Rollback_Call) Run(run func(ctx context.Context, height uint64)) *MockExecutor_Rollback_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockExecutor_Rollback_Call) Return(err error) *MockExecutor_Rollback_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockExecutor_Rollback_Call) RunAndReturn(run func(ctx context.Context, height uint64) error) *MockExecutor_Rollback_Call {
	_c.Call.Return(run)
	return _c
}
