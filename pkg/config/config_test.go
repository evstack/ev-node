...
func TestDefaultConfig(t *testing.T) {
	...
	assert.Equal(t, 1*time.Second, def.Node.BatchRetrievalInterval.Duration)
...
func TestAddFlags(t *testing.T) {
	...
	assertFlagValue(t, flags, FlagBatchRetrievalInterval, DefaultConfig.Node.BatchRetrievalInterval.Duration)
